...
BX.Vue.component('calc-info', 
{
	...
	methods: {
		open: function(title, norm, actual, description) {
			this.title = title;
			this.norm = norm;
			this.actual = actual;
		...
		<div class="block block--separate">
			<div class="value-line">
				...
				<div class="progress progress--danger">
					<div class="progress__bar" role="progressbar" style="width: 38%"></div>
				</div>
				<div class="value-line__value" v-text="actual"></div>
			</div>
		</div>
		<div class="block block--separate">
			<div class="value-line">
				...
				<div class="progress">
					<div class="progress__bar" role="progressbar" style="width: 12%"></div>
				</div>
				<div class="value-line__value" v-text="norm"></div>
			</div>
		</div>
