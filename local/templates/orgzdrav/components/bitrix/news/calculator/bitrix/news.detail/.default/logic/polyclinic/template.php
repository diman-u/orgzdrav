<div class="grid">
	...
	<div class="grid__column" v-if="ready">
		...
		<div class="card card--action">
			<calc-result-2 name="LoadPerOneMedicalPosition" :res="resLoadPerOneMedicalPosition()"></calc-result-2>
		...
		<div class="card card--action">
			<calc-result-2 name="SharePreventiveVisits" :res="resSharePreventiveVisits()"></calc-result-2>
		...
		<div class="card card--action">
			<calc-result-2 name="ShareDiseaseVisits" :res="resShareDiseaseVisits()"></calc-result-2>
		...
		<div class="card card--action">
			<calc-result-2 name="ShareHomeVisits" :res="resShareHomeVisits()"></calc-result-2>
		...
		<div class="card card--action">
			<calc-result-2 name="VisitsPerOneResidentYearEnd" :res="resVisitsPerOneResidentYearEnd()"></calc-result-2>
