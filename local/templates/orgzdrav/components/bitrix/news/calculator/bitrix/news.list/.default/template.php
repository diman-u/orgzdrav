...
<div class="grid grid--xl-3">
	<? foreach ($arResult['ITEMS'] as $i => $arItem): ?>
		<div class="grid__column">
			<div class="tools-item tools-item--big tools-item--theme-<?= $arItem['DISPLAY_PROPERTIES']['theme']['VALUE_XML_ID'] ?>">
                ...
                <div class="btn btn--small btn--white">Расчитать показатели</div>
            </div>
		</div>
	<? endforeach; ?>
</div>