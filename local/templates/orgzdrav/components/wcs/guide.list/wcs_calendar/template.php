...
?>
<? if (empty($arParams['SHOW_TABS']) || 'Y' == $arParams['SHOW_TABS']) : ?>
<div class="section-tabs">
    <ul>
        <li class="<?= $arResult['ARHIVE'] ? '' : 'section-tabs__active' ?>"><a href="/calendar/">Будущие</a></li>
        <li class="<?= $arResult['ARHIVE'] ? 'section-tabs__active' : '' ?>"><a href="/calendar/arhive/">Прошедшие</a></li>
    </ul>
</div>
<? endif; ?>
        ...
        <div class="grid__column">
            <article class="event-item js-cnt" data-type="<?= $arParams['GUIDE'] ?>" data-id="<?= $item['id'] ?>">
                ...
                <div class="event-item__content">
                    ...
                    <div class="post-meta">
                        <div class="post-meta__tag is-big">Мероприятия</div>
